      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.salaryCard}>
          ...
          <View style={styles.salaryRow}>
            ...
            <Text style={styles.salaryValue}>₹{salaryData.baseSalary.toLocaleString()}</Text>
          </View>
          ...
          <View style={styles.salaryRow}>
            ...
            <Text style={styles.salaryValue}>₹{salaryData.perDayRate}</Text>
          </View>
          ...
          <View style={styles.salaryRow}>
            ...
            <Text style={styles.runningSalaryValue}>₹{salaryData.runningSalary.toLocaleString()}</Text>
          </View>
        </View>
        ...
        <View style={styles.adjustmentsCard}>
          ...
          <View style={styles.adjustmentSection}>
            ...
            <View style={styles.adjustmentRow}>
              ...
              <Text style={styles.deductionValue}>-₹{salaryData.deductions.absenceAmount.toLocaleString()}</Text>
            </View>
            
            <View style={styles.adjustmentRow}>
              <Text style={styles.adjustmentLabel}>Half-days ({salaryData.deductions.halfDays} days)</Text>
              <Text style={styles.deductionValue}>-₹{salaryData.deductions.halfDayAmount.toLocaleString()}</Text>
            </View>
            ...
            {salaryData.deductions.lateArrivals.map((item, index) => (
              <View key={index} style={styles.adjustmentRow}>
                ...
                <Text style={styles.deductionValue}>-₹{item.amount}</Text>
              </View>
            ))}
            
            <View style={styles.adjustmentRow}>
              <Text style={styles.totalDeductionLabel}>Total Deductions</Text>
              <Text style={styles.totalDeductionValue}>-₹{totalDeductions.toLocaleString()}</Text>
            </View>
          </View>
          ...
          <View style={styles.adjustmentSection}>
            ...
            <View style={styles.adjustmentRow}>
              ...
              <Text style={styles.additionValue}>+₹{salaryData.additions.overtime.toLocaleString()}</Text>
            </View>
            
            <View style={styles.adjustmentRow}>
              <Text style={styles.adjustmentLabel}>Petrol Allowance</Text>
              <Text style={styles.additionValue}>+₹{salaryData.additions.petrolAllowance.toLocaleString()}</Text>
            </View>
            
            <View style={styles.adjustmentRow}>
              <Text style={styles.totalAdditionLabel}>Total Additions</Text>
              <Text style={styles.totalAdditionValue}>+₹{totalAdditions.toLocaleString()}</Text>
            </View>
          </View>
